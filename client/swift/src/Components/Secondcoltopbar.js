...
function Secondcoltopbar() {
    ...
    return (
        <div>
            {/*  top bar */}
            <div className="flex mb-1 h-24 border border-r-0 border-gray-300 p-6 items-center">
            ...
            {/* search bar */}
            <div className="flex border border-r-0 border-t-0 border-gray-300 justify-center items-center p-4 pt-0 pb-1">
